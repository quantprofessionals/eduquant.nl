...
[[item]]
  ...
  content = "Let our specialists train your junior and senior experts"
...
[[item]]
  ...
  content = "Focus on what matters to you now, with specialised course modules and customization."
  align = "center"  # Choose `center`, `left`, or `right`.

  # Overlay a color or image (optional).
  #   Deactivate an option by commenting out the line, prefixing it with `#`.
  overlay_color = "#666"  # An HTML color value.
  overlay_img = "university_building.jpg"  # Image path relative to your `static/media/` folder.
  overlay_filter = 0.5  # Darken the image. Value in range 0-1.
